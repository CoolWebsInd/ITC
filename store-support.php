...
class Dokan_Store_Support {
    ...
    function place_support_menu( $items ) {
        ...
        $items['support-tickets']   = __( "Mensajes del vendedor", 'dokan-store-support' );
        $items['customer-logout']   = __( 'Cerrar sesión', 'dokan-store-support' );
